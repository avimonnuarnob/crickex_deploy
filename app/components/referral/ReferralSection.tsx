  ...
  return (
    ...
    >
      <TabGroup selectedIndex={selectedTab} onChange={setSelectedTab}>
        <TabList className="flex bg-blue-1 pb-3 px-3.75 pt-2 text-sm sticky top-0 z-10">
          <Tab
            className={({ selected }) =>
              classNames(
                "flex-1 py-0.75 bg-transparent text-white text-center focus:outline-none rounded",
                selected ? "shadow shadow-[#00197980]" : ""
              )
            }
          >
            {({ selected }) => (
          ...
          >
            {({ selected }) => (
              <span
                className={classNames(
                  "block py-1.25 text-[13px] rounded-r",
                  selected ? "bg-[#2d9eff]" : "bg-blue-2"
                )}
              >
                History
            ...
            <div className="p-2.5 border-gray-200">
              ...
              <div className="bg-blue-1 p-4.5">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-blue-500/70 rounded-lg p-3.75 text-center">
                    <p className="text-white text-xs mb-1.25">Today's Rebate</p>
                    <div className="flex items-center justify-center">
            ...
            <div className="p-2.5 border-gray-200">
              ...
              <div className="bg-blue-1 rounded-lg p-4 overflow-hidden">
                <p className="text-white text-xs mb-6">
                  All referrer will receive a certain cash reward percentage for
                  every referee when they play games on CRICKEX.
                </p>
                ...
                <p className="text-white text-xs mb-6">
                  Be diligent in referring, be the upline and earn upto 3 tiers
                  easily.
                </p>
          ...
          <TabPanel>
            <div className="px-4 py-6">
              <div className="bg-white rounded-lg p-4 shadow">
                <h3 className="text-xl font-bold text-blue-700 mb-4 border-l-4 border-blue-700 pl-3">
                  Referral History
                </h3>
