      ...
      <div className="relative">
        <input
          ...
          className={classNames(
            "border-gray-7 bg-gray-8 w-full rounded-sm border px-4 py-3.75 text-xs transition-all focus:ring-none focus:outline-none focus:border-blue-1 font-light",
            {
