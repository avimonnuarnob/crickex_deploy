...
export default function HomeSlider() {
  ...
  return (
    <section className="border-x-2 sm:border-0 border-blue-1 w-full">
      <div className="embla relative xl:flex gap-4 items-center w-full h-full @container">
        <PrevButton
          className="absolute top-1/2 text-[#8d8d8d] z-1 -translate-y-1/2 cursor-pointer left-0 xl:-left-7.5 hidden sm:block"
        ...
        <NextButton
          ...
          className="absolute top-1/2 z-1 text-[#8d8d8d] -translate-y-1/2 cursor-pointer right-0 xl:-right-7.5 hidden sm:block"
        />
      </div>
